...
class MostradorTablas(gtk.Window):
    ...
    def __init__(self):
        ...
        gtk.Window.__init__(self, title="Proyectos de la empresas")
        self.set_default_size(400, 200)
        self.liststore = gtk.ListStore(str, bool)
        self.liststore.append(["dirigir", False])
        self.liststore.append(["empleado", False])
        self.liststore.append(["empresa", False])
        self.liststore.append(["proyecto", False])
        self.liststore.append(["supervisar", False])
        self.liststore.append(["trabajar", False])
